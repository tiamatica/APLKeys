...
import com.athoraya.aplkeys.APLKeyboard.Key;
 ...
 */
public class APLKeyboardView extends View implements View.OnClickListener {
    ...
    public APLKeyboardView(Context context, AttributeSet attrs, int defStyle) {
        ...
        myPaint.setColor(0xFFCCCCCC);     // light grey
...
//        mAccessibilityManager = AccessibilityManager.getInstance(context);
     ...
     */
    private OnKeyboardActionListener getOnKeyboardActionListener() {
...
//            setMeasuredDimension(width, mKeyboard.getHeight() + mPaddingTop + mPaddingBottom);
        ...
        for (Key key : keys) {
            ...
            if (key.codes[0] == 32) {    // draw text bottom right
                ...
                canvas.drawText(subLabel,
                        ...
                        subPaint);
            } else if (subLabel != null) {    // draw text top right
                // Draw the text
                canvas.drawText(subLabel,
                        key.width - padding.right,
                        subPaint.getTextSize() - subPaint.descent() + padding.top,
                        subPaint);
            }
    ...
    private void detectAndSendKey(int index, int x, int y, long eventTime) {
        if (index != NOT_A_KEY && index < mKeys.length) {
            ...
            if (key.text != null) {
                ...
                if (mInMultiTap) {
                    if (mTapCount != -1) {
                        mKeyboardActionListener.onKey(APLKeyboard.KEYCODE_DELETE, KEY_DELETE);
                    } else {
                        mTapCount = 0;
                    }
    ...
    private void sendAccessibilityEventForUnicodeCharacter(int eventType, int code) {
        if (mAccessibilityManager.isEnabled()) {
            ...
            if (isHeadset) {
                switch (code) {
                    case APLKeyboard.KEYCODE_ALT:
                        text = mContext.getString(
                                Resources.getSystem().getIdentifier("keyboardview_keycode_alt", "string", "android"));
                        break;
                    case APLKeyboard.KEYCODE_CANCEL:
                        text = mContext.getString(
                                Resources.getSystem().getIdentifier("keyboardview_keycode_cancel", "string", "android"));
                        break;
                    case APLKeyboard.KEYCODE_DELETE:
                        text = mContext.getString(
                                Resources.getSystem().getIdentifier("keyboardview_keycode_delete", "string", "android"));
                        break;
                    case APLKeyboard.KEYCODE_DONE:
                        text = mContext.getString(
                                Resources.getSystem().getIdentifier("keyboardview_keycode_done", "string", "android"));
                        break;
                    case APLKeyboard.KEYCODE_MODE_CHANGE:
                        text = mContext.getString(
                                Resources.getSystem().getIdentifier("keyboardview_keycode_change", "string", "android"));
                        break;
                    case APLKeyboard.KEYCODE_SHIFT:
                        text = mContext.getString(
                                Resources.getSystem().getIdentifier("keyboardview_keycode_shift", "string", "android"));
                        break;
                    case '\n':
                        text = mContext.getString(
                                Resources.getSystem().getIdentifier("keyboardview_keycode_enter", "string", "android"));
                        break;
                    default:
                ...
                text = mContext.getString(
                        Resources.getSystem().getIdentifier("keyboard_headset_required_to_hear_password", "string", "android"));
            } else {
                //text = mContext.getString(R.string.keyboard_password_character_no_headset);
                text = mContext.getString(
                        Resources.getSystem().getIdentifier("keyboard_password_character_no_headset", "string", "android"));
            }
    ...
    private boolean onLongPress(Key popupKey) {
        View mMiniKeyboardContainer;
        APLKeyboardView mMiniKeyboard;
        ...
        if (popupKey.codes[0] == 32) {
            getOnKeyboardActionListener().onKey(KEYCODE_OPTIONS, null);
            return true;
        }
        int popupKeyboardId = popupKey.popupResId;

        if (popupKeyboardId == 0) return false;
        ...
        if (mMiniKeyboardContainer == null) {
            ...
            if (popupKey.popupCharacters != null) {
                keyboard = new APLKeyboard(getContext(), popupKeyboardId,
